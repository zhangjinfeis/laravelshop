...
@section("content")
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="场馆名称" style="width:400px;" value="" />
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="address" name="address" placeholder="地址" style="width:400px;" value="" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="phone" name="phone" placeholder="电话" style="width:400px;" value="" />
        </div>
        <div class="form-group">
            <label for="price"><span class="text-danger">* </span>价格</label>
            <input type="text" class="form-control" id="price" name="price" placeholder="价格" style="width:400px;" value="" />
        </div>
        <div class="form-group">
            <label>场馆介绍</label>
            <div>
                @include('admin.include.ckeditor',array('input_name'=>'body','custom'=>'ckeditor_full','height'=>400))
            </div>
